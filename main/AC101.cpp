...
esp_err_t AC101::begin() {
  ...
  res |= WriteReg(PLL_CTRL2, 0x8030); // N = 96 @ 0x8600 mclk 12.288Mhz // N = 3
                                      // @ 0x8030 mclk 24.576Mhz
  ...
  res |= WriteReg(ADC_SRC,
                  0x2020); // 0x2020 for mic input // 0x0408 for line input
...
// @return false on success, true on failure.
esp_err_t AC101::SetI2sClock(I2sBitClockDiv_t bitClockDiv, bool bitClockInv,
