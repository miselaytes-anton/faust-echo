...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst1 = (int(std::min<float>((2.0f * fConst0), std::max<float>(0.0f, fConst0))) + 1);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec0[0] = fTemp0;
			fRec11[0] = (0.0f - (fConst3 * ((fConst4 * fRec11[1]) - (fTemp0 + fVec0[1]))));
			fRec10[0] = (0.0f - (fConst3 * ((fConst4 * fRec10[1]) - (fRec11[0] + fRec11[1]))));
			fRec9[0] = (0.0f - (fConst3 * ((fConst4 * fRec9[1]) - (fRec10[0] + fRec10[1]))));
			fRec8[(IOTA & 262143)] = ((0.5f * fRec8[((IOTA - iConst1) & 262143)]) + (0.600000024f * fRec9[0]));
...
FaustEcho::FaustEcho(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
extern "C" void app_main()
{
    ...
    FaustEcho* DSP = new FaustEcho(48000, 32);
    DSP->start();
